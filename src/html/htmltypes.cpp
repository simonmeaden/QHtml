...
#include "SMLibraries/language/languages.h"
#include "SMLibraries/utilities/paths.h"
...
HtmlTypes::initTagTypeMap()
{
  ...
  map.insert("ol", mappedAttributes);
...
HtmlTypes::initHtmlTagNames()
{
  QVector<QString> vec{
    "html",     "body",       "a",        "b",          "i",        "ul",
    "ol",       "li",         "dl",       "dd",         "dt",       "em",
    "strong",   "br",         "div",      "p",          "link",     "meta",
    "h1",       "h2",         "h3",       "h4",         "h5",       "h6",
    "abbr",     "address",    "area",     "article",    "aside",    "audio",
    "base",     "bdi",        "bdo",      "blockquote", "button",   "canvas",
    "caption",  "cite",       "code",     "col",        "colgroup", "data",
    "datalist", "del",        "details",  "dfn",        "dialog",   "embed",
    "fieldset", "figcaption", "figure",   "footer",     "form",     "head",
    "header",
    "hgroup", // deprecated in HTML 5
    "hr",       "iframe",     "img",      "input",      "ins",      "kbd",
    "label",    "legend",     "main",     "map",        "mark",     "menu",
    "meter",    "nav",        "noscript", "object",     "optgroup", "option",
    "output",   "param",      "picture",  "pre",        "progress", "q",
    "rb",       "rp",         "rt",       "rtc",        "ruby",     "s",
    "samp",     "script",     "section",  "select",     "slot",     "small",
    "source",   "span",       "style",    "sub",        "summary",  "sup",
